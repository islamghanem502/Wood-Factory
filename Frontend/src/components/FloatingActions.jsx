  ...
  return (
    ...
    >
      <div className="flex flex-col items-end gap-2.5">
        {showHint && (
          <div className="flex items-center gap-2 bg-[#12151b] border border-[#cba157]/40 text-[#f7dfa5] text-xs py-1.5 px-3.5 rounded-full shadow-2xl animate-bounce">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-ping" />
            <span>مهندس الاستشارات متاح الآن للمحادثة</span>
            <button
              type="button"
        ...
        <div className="flex items-center gap-2 bg-[#0d0f13]/95 backdrop-blur-xl p-2 rounded-2xl border border-[#cba157]/30 shadow-2xl">
          <button
            ...
            className="flex items-center gap-2 px-3.5 py-2.5 rounded-xl gold-gradient-bg text-black font-bold text-xs sm:text-sm hover:brightness-110 transition-all shadow-md active:scale-95"
          >
            <CalendarCheck className="w-4 h-4" />
            <span className="hidden sm:inline">طلب استشارة مجانية</span>
