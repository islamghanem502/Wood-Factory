...
export const OFFER = {
  ...
  text: "بمناسبة اليوم الوطني السادس والتسعين، سعر المتر المربع 996 ر.س بدلاً من 1150 — لفترة محدودة.",
  price: 996,
  listPrice: 1150,
  unit: "ر.س / م²",
  ...
  whatsapp: "مرحباً خشبي، أرغب في الاستفادة من عرض اليوم الوطني 96 (996 ر.س للمتر).",
...
export const FOOTER = {
  ...
  ctaText: "راسلنا على الواتساب أو اتصل بنا، ونرد عليك بتقدير مبدئي.",
  about: "أكواخ وبرجولات من خشب السنوبر، تُصنع في مصنعنا وتُركَّب في موقعك.",
  specs: ["جدار سنوبر مصمت 12 سم", "سقف من 5 طبقات", "ضمان يصل حتى 15 سنة"],
