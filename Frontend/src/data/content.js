...
export const OFFER = {
  ...
  title: ["كوخك بسعر", "996 ر.س للمتر."],
  text: "بمناسبة اليوم الوطني السادس والتسعين، سعر المتر المربع 996 ر.س بدلاً من 1150 — على الأكواخ والبرجولات كلها، وبنفس المواصفات: جدار سنوبر 12 سم، سقف من 5 طبقات، وضمان يصل حتى 15 سنة.",
  price: 996,
  listPrice: 1150,
  unit: "ر.س / م²",
  note: "لفترة محدودة، ويسري على التعاقدات خلال فترة العرض.",
  cta: "احجز بسعر العرض",
